...
<%
    String question = "What is the highest peak in the Himalayas located in India?";
    String[] options = {"Nanda Devi", "Kanchenjunga", "Mount Everest", "Trisul"};
    String answer = "Kanchenjunga";
    session.setAttribute("correct", answer);
%>
<!DOCTYPE html>
<html>
<head>
  <title>KBC Question 1</title>
